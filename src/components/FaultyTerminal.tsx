...
float digit(vec2 p) {
  ...
  if(uUseMouse > 0.5) {
    ...
    float inf = exp(-dist * 8.0) * uMouseStrength * 10.0;
    intensity += inf;
    intensity += sin(dist * 20.0 - iTime * 5.0) * 0.1 * inf;
  }
...
export default function FaultyTerminal({
  ...
  useEffect(() => {
    ...
    curvature, tintVec, mouseReact, mouseStrength, pageLoadAnimation, brightness,
    handleMouseMove,
  ]);
